 ...
 * array element index2. Specifying a `context` for the function is optional.
 *
...
function qFactory(nextTick, exceptionHandler) {
   ...
   *   each value corresponding to the promise at the same index2 in the `promises` array. If any of
      ...
      <script>
        function SettingsController($scope) {
          ...
          $scope.removeContact = function(contactToRemove) {
           var index2 = this.contacts.indexOf(contactToRemove);
           this.contacts.splice(index2, 1);
          };
 ...
 * and `$index2` is set to the item index2 or key.
 *
 * Special properties are exposed on the local scope of each template instance, including:
 *
 *   * `$index2` â€“ `{number}` â€“ iterator offset of the repeated element (0..length-1)
        ...
        <div ng-init="friends = [{name:'John', age:25}, {name:'Mary', age:28}]">
          ...
          <ul>
            <li ng-repeat="friend in friends">
              [{{$index2 + 1}}] {{friend.name}} who is {{friend.age}} years old.
            </li>
          </ul>
        </div>
      </doc:source>
    ...
    return function(scope, iterStartElement, attr){
      ...
      scope.$watch(function ngRepeatWatch(scope){
        var index, length,
            ...
            array,
            last;       // last object information {scope, element, index2}
        ...
        <div ng-controller="MyCntrl">
          <ul>
            <li ng-repeat="color in colors">
              ...
              [<a href ng-click="colors.splice($index2, 1)">X</a>]
            </li>
            <li>
      ...
      function Options(scope, selectElement, ctrl) {
        ...
        function render() {
          ...
          for (index = 0; length = keys.length, index < length; index++) {
            ...
            optionGroup.push({
              id: keyName ? keys[index] : index,   // either the index2 into array or key from object
              label: label,
