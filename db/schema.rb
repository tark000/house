...
ActiveRecord::Schema.define(:version => 0) do
  ...
  add_index "adverts", ["contact_id"], :name => "advert_advert_170b8823"
  ...
  add_index "adverts", ["fund_type_id"], :name => "advert_advert_1326b494"
  ...
  add_index "streets", ["city_id"], :name => "advert_street_a3ca7998"

  create_table "streets_ald", :force => true do |t|
    t.string  "name"
    t.integer "city_id"
    t.integer "district_id"
  end
